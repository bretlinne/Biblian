...
function statusContainerAction(obj){
  ...
  let progressContainer =         obj.parentNode.parentNode.parentNode.childNodes[0].childNodes[1].childNodes[1];
  let progressContainerFinished = obj.parentNode.parentNode.parentNode.childNodes[0].childNodes[1].childNodes[4];
  ...
  console.log('progressContainerFinished: ', progressContainerFinished);
  ...
  if(status === 'reading'){
      ...
      progressContainerFinished.style.display = 'block';
  }else{
      obj.setAttribute('statusValue', 'reading');
      obj.setAttribute('class', 'statusReading');
      finished = 0;
      progressContainer.style.display = 'block';
      progressContainerFinished.style.display = 'none';
  }
...
(function (){
  ...
  // // deal with swapping in a stand in progress bar for finished status
  // // -----------------------------------------------------------------
  // var progressContainersFinished = document.getElementsByClassName('progress-container-finished');
  // for (let i = 0; i < progressContainersFinished.length; i++) {
  //   const elem = progressContainersFinished[i];
  //   let status = elem.parentNode.parentNode.parentNode.childNodes[1].childNodes[1].childNodes[0].getAttribute('statusvalue');
  //   let fBookIdNode = elem.parentNode.parentNode.parentNode.parentNode.childNodes[0].childNodes[0];
  //   let bookId = fBookIdNode.getAttribute('book-id');
  //   let fPageCount = elem.childNodes[2].childNodes[1].getAttribute('value');
  //   let fProgressValue = elem.childNodes[3].childNodes[0].getAttribute('value');
  //   let fProgressStandIn = elem.parentNode.childNodes[2];
  //   let fPageCountUpdateButton = elem.parentNode.childNodes[3];
  //   let fDateStartedLabel = elem.childNodes[3].childNodes[4];
  //   let fDateStartedValue = fDateStartedLabel.getAttribute('value');
    
  //   console.log('fPageCountUpdateButton: ', fPageCountUpdateButton);
    
  //   // TURN OFF DISPLAY OF PROGRESS BAR AND INPUTS IF NO PAGECOUNT
  //   if(!fPageCount && (status === 'reading')){
  //     elem.style.display = 'none';
  //   }else if (!fPageCount && (status === 'finished')){
  //     fDateStartedLabel.style.display = 'none';
  //     fProgressStandIn.style.display = 'none';
  //     fPageCountUpdateButton.style.display = 'none';
  //     if(!fProgressValue || fProgressValue < 1){
  //       fDateStartedLabel.style.display = 'none';
  //     }else{
  //       fDateStartedLabel.style.display = 'block';
  //       fDateStartedLabel.innerHTML = 'Started: ' + fDateStartedValue;
  //     }
  //   }
  // }
